package com.louis.agricultural.base.adapter;
...
public class ViewHolder {
    ...
    public ViewHolder setImageResource(int viewId, String url) {
        ImageView iv = getView(viewId);
        ImageLoadProxy.displayHeadIcon(url, iv);
        return this;
    }

    public ViewHolder setHeadImageResource(int viewId, String url) {
        ImageView iv = getView(viewId);
        ImageLoadProxy.displayImageWithLoadingPicture(url, iv, R.mipmap.ic_launcher);
        return this;
    }
}
